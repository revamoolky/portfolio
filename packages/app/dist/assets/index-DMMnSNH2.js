(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function e(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(s){if(s.ep)return;s.ep=!0;const o=e(s);fetch(s.href,o)}})();var B,we;class nt extends Error{}nt.prototype.name="InvalidTokenError";function qs(i){return decodeURIComponent(atob(i).replace(/(.)/g,(t,e)=>{let r=e.charCodeAt(0).toString(16).toUpperCase();return r.length<2&&(r="0"+r),"%"+r}))}function Vs(i){let t=i.replace(/-/g,"+").replace(/_/g,"/");switch(t.length%4){case 0:break;case 2:t+="==";break;case 3:t+="=";break;default:throw new Error("base64 string is not of the correct length")}try{return qs(t)}catch{return atob(t)}}function Ze(i,t){if(typeof i!="string")throw new nt("Invalid token specified: must be a string");t||(t={});const e=t.header===!0?0:1,r=i.split(".")[e];if(typeof r!="string")throw new nt(`Invalid token specified: missing part #${e+1}`);let s;try{s=Vs(r)}catch(o){throw new nt(`Invalid token specified: invalid base64 for part #${e+1} (${o.message})`)}try{return JSON.parse(s)}catch(o){throw new nt(`Invalid token specified: invalid json for part #${e+1} (${o.message})`)}}const Bs="mu:context",Xt=`${Bs}:change`;class Fs{constructor(t,e){this._proxy=Ys(t,e)}get value(){return this._proxy}set value(t){Object.assign(this._proxy,t)}apply(t){this.value=t(this.value)}}class Qe extends HTMLElement{constructor(t){super(),console.log("Constructing context provider",this),this.context=new Fs(t,this),this.style.display="contents"}attach(t){return this.addEventListener(Xt,t),t}detach(t){this.removeEventListener(Xt,t)}}function Ys(i,t){return new Proxy(i,{get:(r,s,o)=>{if(s==="then")return;const n=Reflect.get(r,s,o);return console.log(`Context['${s}'] => `,n),n},set:(r,s,o,n)=>{const l=i[s];console.log(`Context['${s.toString()}'] <= `,o);const a=Reflect.set(r,s,o,n);if(a){let d=new CustomEvent(Xt,{bubbles:!0,cancelable:!0,composed:!0});Object.assign(d,{property:s,oldValue:l,value:o}),t.dispatchEvent(d)}else console.log(`Context['${s}] was not set to ${o}`);return a}})}function Ws(i,t){const e=ts(t,i);return new Promise((r,s)=>{if(e){const o=e.localName;customElements.whenDefined(o).then(()=>r(e))}else s({context:t,reason:`No provider for this context "${t}:`})})}function ts(i,t){const e=`[provides="${i}"]`;if(!t||t===document.getRootNode())return;const r=t.closest(e);if(r)return r;const s=t.getRootNode();if(s instanceof ShadowRoot)return ts(i,s.host)}class Gs extends CustomEvent{constructor(t,e="mu:message"){super(e,{bubbles:!0,composed:!0,detail:t})}}function es(i="mu:message"){return(t,...e)=>t.dispatchEvent(new Gs(e,i))}class se{constructor(t,e,r="service:message",s=!0){this._pending=[],this._context=e,this._update=t,this._eventType=r,this._running=s}attach(t){t.addEventListener(this._eventType,e=>{e.stopPropagation();const r=e.detail;this.consume(r)})}start(){this._running||(console.log(`Starting ${this._eventType} service`),this._running=!0,this._pending.forEach(t=>this.process(t)))}apply(t){this._context.apply(t)}consume(t){this._running?this.process(t):(console.log(`Queueing ${this._eventType} message`,t),this._pending.push(t))}process(t){console.log(`Processing ${this._eventType} message`,t);const e=this._update(t,this.apply.bind(this));e&&e(this._context.value)}}function Ks(i){return t=>({...t,...i})}const Zt="mu:auth:jwt",ss=class rs extends se{constructor(t,e){super((r,s)=>this.update(r,s),t,rs.EVENT_TYPE),this._redirectForLogin=e}update(t,e){switch(t[0]){case"auth/signin":const{token:r,redirect:s}=t[1];return e(Xs(r)),Ft(s);case"auth/signout":return e(Zs()),Ft(this._redirectForLogin);case"auth/redirect":return Ft(this._redirectForLogin,{next:window.location.href});default:const o=t[0];throw new Error(`Unhandled Auth message "${o}"`)}}};ss.EVENT_TYPE="auth:message";let is=ss;const os=es(is.EVENT_TYPE);function Ft(i,t={}){if(!i)return;const e=window.location.href,r=new URL(i,e);return Object.entries(t).forEach(([s,o])=>r.searchParams.set(s,o)),()=>{console.log("Redirecting to ",i),window.location.assign(r)}}class Js extends Qe{get redirect(){return this.getAttribute("redirect")||void 0}constructor(){const t=K.authenticateFromLocalStorage();super({user:t,token:t.authenticated?t.token:void 0})}connectedCallback(){new is(this.context,this.redirect).attach(this)}}class ht{constructor(){this.authenticated=!1,this.username="anonymous"}static deauthenticate(t){return t.authenticated=!1,t.username="anonymous",localStorage.removeItem(Zt),t}}class K extends ht{constructor(t){super();const e=Ze(t);console.log("Token payload",e),this.token=t,this.authenticated=!0,this.username=e.username}static authenticate(t){const e=new K(t);return localStorage.setItem(Zt,t),e}static authenticateFromLocalStorage(){const t=localStorage.getItem(Zt);return t?K.authenticate(t):new ht}}function Xs(i){return Ks({user:K.authenticate(i),token:i})}function Zs(){return i=>{const t=i.user;return{user:t&&t.authenticated?ht.deauthenticate(t):t,token:""}}}function Qs(i){return i.authenticated?{Authorization:`Bearer ${i.token||"NO_TOKEN"}`}:{}}function tr(i){return i.authenticated?Ze(i.token||""):{}}const er=Object.freeze(Object.defineProperty({__proto__:null,AuthenticatedUser:K,Provider:Js,User:ht,dispatch:os,headers:Qs,payload:tr},Symbol.toStringTag,{value:"Module"}));function Qt(i,t,e){const r=i.target,s=new CustomEvent(t,{bubbles:!0,composed:!0,detail:e});console.log(`Relaying event from ${i.type}:`,s),r.dispatchEvent(s),i.stopPropagation()}function Ae(i,t="*"){return i.composedPath().find(r=>{const s=r;return s.tagName&&s.matches(t)})}function ns(i,...t){const e=i.map((s,o)=>o?[t[o-1],s]:[s]).flat().join("");let r=new CSSStyleSheet;return r.replaceSync(e),r}const sr=new DOMParser;function I(i,...t){const e=t.map(l),r=i.map((a,d)=>{if(d===0)return[a];const m=e[d-1];return m instanceof Node?[`<ins id="mu-html-${d-1}"></ins>`,a]:[m,a]}).flat().join(""),s=sr.parseFromString(r,"text/html"),o=s.head.childElementCount?s.head.children:s.body.children,n=new DocumentFragment;return n.replaceChildren(...o),e.forEach((a,d)=>{if(a instanceof Node){const m=n.querySelector(`ins#mu-html-${d}`);if(m){const u=m.parentNode;u==null||u.replaceChild(a,m)}else console.log("Missing insertion point:",`ins#mu-html-${d}`)}}),n;function l(a,d){if(a===null)return"";switch(typeof a){case"string":return Ee(a);case"bigint":case"boolean":case"number":case"symbol":return Ee(a.toString());case"object":if(a instanceof Node||a instanceof DocumentFragment)return a;if(Array.isArray(a)){const m=new DocumentFragment,u=a.map(l);return m.replaceChildren(...u),m}return new Text(a.toString());default:return new Comment(`[invalid parameter of type "${typeof a}"]`)}}}function Ee(i){return i.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Lt(i,t={mode:"open"}){const e=i.attachShadow(t),r={template:s,styles:o};return r;function s(n){const l=n.firstElementChild,a=l&&l.tagName==="TEMPLATE"?l:void 0;return a&&e.appendChild(a.content.cloneNode(!0)),r}function o(...n){e.adoptedStyleSheets=n}}B=class extends HTMLElement{constructor(){super(),this._state={},Lt(this).template(B.template).styles(B.styles),this.addEventListener("change",i=>{const t=i.target;if(t){const e=t.name,r=t.value;e&&(this._state[e]=r)}}),this.form&&this.form.addEventListener("submit",i=>{i.preventDefault(),Qt(i,"mu-form:submit",this._state)})}set init(i){this._state=i||{},rr(this._state,this)}get form(){var i;return(i=this.shadowRoot)==null?void 0:i.querySelector("form")}},B.template=I`
    <template>
...
`+this.showPosition(),{text:"",token:null,line:this.yylineno})},lex:function(){var h=this.next();return h||this.lex()},begin:function(h){this.conditionStack.push(h)},popState:function(){var h=this.conditionStack.length-1;return h>0?this.conditionStack.pop():this.conditionStack[0]},_currentRules:function(){return this.conditionStack.length&&this.conditionStack[this.conditionStack.length-1]?this.conditions[this.conditionStack[this.conditionStack.length-1]].rules:this.conditions.INITIAL.rules},topState:function(h){return h=this.conditionStack.length-1-Math.abs(h||0),h>=0?this.conditionStack[h]:"INITIAL"},pushState:function(h){this.begin(h)},stateStackSize:function(){return this.conditionStack.length},options:{},performAction:function(h,p,g,f){switch(g){case 0:return"(";case 1:return")";case 2:return"SPLAT";case 3:return"PARAM";case 4:return"LITERAL";case 5:return"LITERAL";case 6:return"EOF"}},rules:[/^(?:\()/,/^(?:\))/,/^(?:\*+\w+)/,/^(?::+\w+)/,/^(?:[\w%\-~\n]+)/,/^(?:.)/,/^(?:$)/],conditions:{INITIAL:{rules:[0,1,2,3,4,5,6],inclusive:!0}}};return u}();a.lexer=d;function m(){this.yy={}}return m.prototype=a,a.Parser=m,new m}();typeof Nr<"u"&&(i.parser=t,i.Parser=t.Parser,i.parse=function(){return t.parse.apply(t,arguments)})})(bs);function F(i){return function(t,e){return{displayName:i,props:t,children:e||[]}}}var $s={Root:F("Root"),Concat:F("Concat"),Literal:F("Literal"),Splat:F("Splat"),Param:F("Param"),Optional:F("Optional")},ws=bs.parser;ws.yy=$s;var Ur=ws,Mr=Object.keys($s);function jr(i){return Mr.forEach(function(t){if(typeof i[t]>"u")throw new Error("No handler defined for "+t.displayName)}),{visit:function(t,e){return this.handlers[t.displayName].call(this,t,e)},handlers:i}}var As=jr,Lr=As,Ir=/[\-{}\[\]+?.,\\\^$|#\s]/g;function Es(i){this.captures=i.captures,this.re=i.re}Es.prototype.match=function(i){var t=this.re.exec(i),e={};if(t)return this.captures.forEach(function(r,s){typeof t[s+1]>"u"?e[r]=void 0:e[r]=decodeURIComponent(t[s+1])}),e};var Hr=Lr({Concat:function(i){return i.children.reduce((function(t,e){var r=this.visit(e);return{re:t.re+r.re,captures:t.captures.concat(r.captures)}}).bind(this),{re:"",captures:[]})},Literal:function(i){return{re:i.props.value.replace(Ir,"\\$&"),captures:[]}},Splat:function(i){return{re:"([^?]*?)",captures:[i.props.name]}},Param:function(i){return{re:"([^\\/\\?]+)",captures:[i.props.name]}},Optional:function(i){var t=this.visit(i.children[0]);return{re:"(?:"+t.re+")?",captures:t.captures}},Root:function(i){var t=this.visit(i.children[0]);return new Es({re:new RegExp("^"+t.re+"(?=\\?|$)"),captures:t.captures})}}),zr=Hr,Dr=As,qr=Dr({Concat:function(i,t){var e=i.children.map((function(r){return this.visit(r,t)}).bind(this));return e.some(function(r){return r===!1})?!1:e.join("")},Literal:function(i){return decodeURI(i.props.value)},Splat:function(i,t){return t[i.props.name]?t[i.props.name]:!1},Param:function(i,t){return t[i.props.name]?t[i.props.name]:!1},Optional:function(i,t){var e=this.visit(i.children[0],t);return e||""},Root:function(i,t){t=t||{};var e=this.visit(i.children[0],t);return e?encodeURI(e):!1}}),Vr=qr,Br=Ur,Fr=zr,Yr=Vr;bt.prototype=Object.create(null);bt.prototype.match=function(i){var t=Fr.visit(this.ast),e=t.match(i);return e||!1};bt.prototype.reverse=function(i){return Yr.visit(this.ast,i)};function bt(i){var t;if(this?t=this:t=Object.create(bt.prototype),typeof i>"u")throw new Error("A route spec is required");return t.spec=i,t.ast=Br.parse(i),t}var Wr=bt,Gr=Wr,Kr=Gr;const Jr=Rr(Kr);var Xr=Object.defineProperty,Ss=(i,t,e,r)=>{for(var s=void 0,o=i.length-1,n;o>=0;o--)(n=i[o])&&(s=n(t,e,s)||s);return s&&Xr(t,e,s),s};const xs=class extends G{constructor(t,e,r=""){super(),this._cases=[],this._fallback=()=>it` <h1>Not Found</h1> `,this._cases=t.map(s=>({...s,route:new Jr(s.path)})),this._historyObserver=new Pt(this,e),this._authObserver=new Pt(this,r)}connectedCallback(){this._historyObserver.observe(({location:t})=>{console.log("New location",t),t&&(this._match=this.matchRoute(t))}),this._authObserver.observe(({user:t})=>{this._user=t}),super.connectedCallback()}render(){return console.log("Rendering for match",this._match,this._user),it` <main>${(()=>{const e=this._match;if(e){if("view"in e)return this._user?e.auth&&e.auth!=="public"&&this._user&&!this._user.authenticated?(os(this,"auth/redirect"),it` <h1>Redirecting for Login</h1> `):(console.log("Loading view, ",e.params,e.query),e.view(e.params||{},e.query)):it` <h1>Authenticating</h1> `;if("redirect"in e){const r=e.redirect;if(typeof r=="string")return this.redirect(r),it` <h1>Redirecting to ${r}…</h1> `}}return this._fallback({})})()}</main> `}updated(t){t.has("_match")&&this.requestUpdate()}matchRoute(t){const{search:e,pathname:r}=t,s=new URLSearchParams(e),o=r+e;for(const n of this._cases){const l=n.route.match(o);if(l)return{...n,path:r,params:l,query:s}}}redirect(t){ie(this,"history/redirect",{href:t})}};xs.styles=ur`
  ...
  `;const Ps=class ee extends HTMLElement{constructor(){super(),this._array=[],Lt(this).template(ee.template).styles(ee.styles),this.addEventListener("input-array:add",t=>{t.stopPropagation(),this.append(Cs("",this._array.length))}),this.addEventListener("input-array:remove",t=>{t.stopPropagation(),this.removeClosestItem(t.target)}),this.addEventListener("change",t=>{t.stopPropagation();const e=t.target;if(e&&e!==this){const r=new Event("change",{bubbles:!0}),s=e.value,o=e.closest("label");if(o){const n=Array.from(this.children).indexOf(o);this._array[n]=s,this.dispatchEvent(r)}}}),this.addEventListener("click",t=>{Ae(t,"button.add")?Qt(t,"input-array:add"):Ae(t,"button.remove")&&Qt(t,"input-array:remove")})}get name(){return this.getAttribute("name")}get value(){return this._array}set value(t){this._array=Array.isArray(t)?t:[t],ti(this._array,this)}removeClosestItem(t){const e=t.closest("label");if(console.log("Removing closest item:",e,t),e){const r=Array.from(this.children).indexOf(e);this._array.splice(r,1),e.remove()}}};Ps.template=I`
    <template>
      <ul>
        <slot></slot>
      </ul>
...
\f\r]`,ot=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ye=/-->/g,We=/>/g,M=RegExp(`>|${Gt}(?:([^\\s"'>=/]+)(${Gt}*=${Gt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ge=/'/g,Ke=/"/g,Ns=/^(?:script|style|textarea|title)$/i,yi=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),w=yi(1),Q=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),Je=new WeakMap,L=D.createTreeWalker(D,129);function Us(i,t){if(!de(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Fe!==void 0?Fe.createHTML(t):t}const vi=(i,t)=>{const e=i.length-1,r=[];let s,o=t===2?"<svg>":t===3?"<math>":"",n=ot;for(let l=0;l<e;l++){const a=i[l];let d,m,u=-1,c=0;for(;c<a.length&&(n.lastIndex=c,m=n.exec(a),m!==null);)c=n.lastIndex,n===ot?m[1]==="!--"?n=Ye:m[1]!==void 0?n=We:m[2]!==void 0?(Ns.test(m[2])&&(s=RegExp("</"+m[2],"g")),n=M):m[3]!==void 0&&(n=M):n===M?m[0]===">"?(n=s??ot,u=-1):m[1]===void 0?u=-2:(u=n.lastIndex-m[2].length,d=m[1],n=m[3]===void 0?M:m[3]==='"'?Ke:Ge):n===Ke||n===Ge?n=M:n===Ye||n===We?n=ot:(n=M,s=void 0);const h=n===M&&i[l+1].startsWith("/>")?" ":"";o+=n===ot?a+fi:u>=0?(r.push(d),a.slice(0,u)+Os+a.slice(u)+C+h):a+C+(u===-2?l:h)}return[Us(i,o+(i[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),r]};class ft{constructor({strings:t,_$litType$:e},r){let s;this.parts=[];let o=0,n=0;const l=t.length-1,a=this.parts,[d,m]=vi(t,e);if(this.el=ft.createElement(d,r),L.currentNode=this.el.content,e===2||e===3){const u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(s=L.nextNode())!==null&&a.length<l;){if(s.nodeType===1){if(s.hasAttributes())for(const u of s.getAttributeNames())if(u.endsWith(Os)){const c=m[n++],h=s.getAttribute(u).split(C),p=/([.?@])?(.*)/.exec(c);a.push({type:1,index:o,name:p[2],strings:h,ctor:p[1]==="."?bi:p[1]==="?"?$i:p[1]==="@"?wi:Ht}),s.removeAttribute(u)}else u.startsWith(C)&&(a.push({type:6,index:o}),s.removeAttribute(u));if(Ns.test(s.tagName)){const u=s.textContent.split(C),c=u.length-1;if(c>0){s.textContent=Ut?Ut.emptyScript:"";for(let h=0;h<c;h++)s.append(u[h],pt()),L.nextNode(),a.push({type:2,index:++o});s.append(u[c],pt())}}}else if(s.nodeType===8)if(s.data===Rs)a.push({type:2,index:o});else{let u=-1;for(;(u=s.data.indexOf(C,u+1))!==-1;)a.push({type:7,index:o}),u+=C.length-1}o++}}static createElement(t,e){const r=D.createElement("template");return r.innerHTML=t,r}}function tt(i,t,e=i,r){var n,l;if(t===Q)return t;let s=r!==void 0?(n=e._$Co)==null?void 0:n[r]:e._$Cl;const o=mt(t)?void 0:t._$litDirective$;return(s==null?void 0:s.constructor)!==o&&((l=s==null?void 0:s._$AO)==null||l.call(s,!1),o===void 0?s=void 0:(s=new o(i),s._$AT(i,e,r)),r!==void 0?(e._$Co??(e._$Co=[]))[r]=s:e._$Cl=s),s!==void 0&&(t=tt(i,s._$AS(i,t.values),s,r)),t}class _i{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:r}=this._$AD,s=((t==null?void 0:t.creationScope)??D).importNode(e,!0);L.currentNode=s;let o=L.nextNode(),n=0,l=0,a=r[0];for(;a!==void 0;){if(n===a.index){let d;a.type===2?d=new $t(o,o.nextSibling,this,t):a.type===1?d=new a.ctor(o,a.name,a.strings,this,t):a.type===6&&(d=new Ai(o,this,t)),this._$AV.push(d),a=r[++l]}n!==(a==null?void 0:a.index)&&(o=L.nextNode(),n++)}return L.currentNode=D,s}p(t){let e=0;for(const r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,e),e+=r.strings.length-2):r._$AI(t[e])),e++}}class $t{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,e,r,s){this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=r,this.options=s,this._$Cv=(s==null?void 0:s.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=tt(this,t,e),mt(t)?t===b||t==null||t===""?(this._$AH!==b&&this._$AR(),this._$AH=b):t!==this._$AH&&t!==Q&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):gi(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==b&&mt(this._$AH)?this._$AA.nextSibling.data=t:this.T(D.createTextNode(t)),this._$AH=t}$(t){var o;const{values:e,_$litType$:r}=t,s=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=ft.createElement(Us(r.h,r.h[0]),this.options)),r);if(((o=this._$AH)==null?void 0:o._$AD)===s)this._$AH.p(e);else{const n=new _i(s,this),l=n.u(this.options);n.p(e),this.T(l),this._$AH=n}}_$AC(t){let e=Je.get(t.strings);return e===void 0&&Je.set(t.strings,e=new ft(t)),e}k(t){de(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let r,s=0;for(const o of t)s===e.length?e.push(r=new $t(this.O(pt()),this.O(pt()),this,this.options)):r=e[s],r._$AI(o),s++;s<e.length&&(this._$AR(r&&r._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){var r;for((r=this._$AP)==null?void 0:r.call(this,!1,!0,e);t&&t!==this._$AB;){const s=t.nextSibling;t.remove(),t=s}}setConnected(t){var e;this._$AM===void 0&&(this._$Cv=t,(e=this._$AP)==null||e.call(this,t))}}class Ht{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,r,s,o){this.type=1,this._$AH=b,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=o,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=b}_$AI(t,e=this,r,s){const o=this.strings;let n=!1;if(o===void 0)t=tt(this,t,e,0),n=!mt(t)||t!==this._$AH&&t!==Q,n&&(this._$AH=t);else{const l=t;let a,d;for(t=o[0],a=0;a<o.length-1;a++)d=tt(this,l[r+a],e,a),d===Q&&(d=this._$AH[a]),n||(n=!mt(d)||d!==this._$AH[a]),d===b?t=b:t!==b&&(t+=(d??"")+o[a+1]),this._$AH[a]=d}n&&!s&&this.j(t)}j(t){t===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class bi extends Ht{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===b?void 0:t}}class $i extends Ht{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==b)}}class wi extends Ht{constructor(t,e,r,s,o){super(t,e,r,s,o),this.type=5}_$AI(t,e=this){if((t=tt(this,t,e,0)??b)===Q)return;const r=this._$AH,s=t===b&&r!==b||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,o=t!==b&&(r===b||s);s&&this.element.removeEventListener(this.name,this,r),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e;typeof this._$AH=="function"?this._$AH.call(((e=this.options)==null?void 0:e.host)??this.element,t):this._$AH.handleEvent(t)}}class Ai{constructor(t,e,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){tt(this,t)}}const Kt=ct.litHtmlPolyfillSupport;Kt==null||Kt(ft,$t),(ct.litHtmlVersions??(ct.litHtmlVersions=[])).push("3.3.0");const Ei=(i,t,e)=>{const r=(e==null?void 0:e.renderBefore)??t;let s=r._$litPart$;if(s===void 0){const o=(e==null?void 0:e.renderBefore)??null;r._$litPart$=s=new $t(t.insertBefore(pt(),o),o,void 0,e??{})}return s._$AI(i),s};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const H=globalThis;class S extends W{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;const t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ei(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)==null||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)==null||t.setConnected(!1)}render(){return Q}}var Xe;S._$litElement$=!0,S.finalized=!0,(Xe=H.litElementHydrateSupport)==null||Xe.call(H,{LitElement:S});const Jt=H.litElementPolyfillSupport;Jt==null||Jt({LitElement:S});(H.litElementVersions??(H.litElementVersions=[])).push("4.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function wt(i){return k({...i,state:!0,attribute:!1})}var ki=Object.defineProperty,Pi=(i,t,e,r)=>{for(var s=void 0,o=i.length-1,n;o>=0;o--)(n=i[o])&&(s=n(t,e,s)||s);return s&&ki(t,e,s),s};const pe=class pe extends S{constructor(){super(...arguments),this.isDarkMode=!1}handleDarkModeToggle(){this.isDarkMode=!this.isDarkMode,document.body.classList.toggle("dark",this.isDarkMode)}render(){return w`
      <header>
        <nav>
          <a href="/app">Home</a>
  ...
  `;let Mt=pe;Pi([wt()],Mt.prototype,"isDarkMode");var Ci=Object.defineProperty,Ms=(i,t,e,r)=>{for(var s=void 0,o=i.length-1,n;o>=0;o--)(n=i[o])&&(s=n(t,e,s)||s);return s&&Ci(t,e,s),s};const me=class me extends S{constructor(){super(...arguments),this.isLocked=!0,this.errorMessage=""}handlePasswordSubmit(t){t.preventDefault(),t.target.querySelector("#password-input").value==="your-password-here"?(this.isLocked=!1,this.errorMessage=""):this.errorMessage="Incorrect password. Please try again."}render(){return this.isLocked?w`
        <div class="lock-screen">
          <div class="card">
            ...
            ${this.errorMessage?w`<p class="error">${this.errorMessage}</p>`:""}
          </div>
        </div>
      `:w`
      <main>
  ...
  `;let yt=fe;js([wt()],yt.prototype,"responseMessage");js([wt()],yt.prototype,"isSubmitting");var Oi=Object.defineProperty,Ls=(i,t,e,r)=>{for(var s=void 0,o=i.length-1,n;o>=0;o--)(n=i[o])&&(s=n(t,e,s)||s);return s&&Oi(t,e,s),s};const ge=class ge extends S{constructor(){super(...arguments),this.heading="",this.paragraph=""}render(){return w`
      <section class="block">
        <h6>Empathize</h6>
  ...
  `;let vt=ge;Ls([k({type:String})],vt.prototype,"heading");Ls([k({type:String})],vt.prototype,"paragraph");customElements.define("empathize-section",vt);var Ri=Object.defineProperty,At=(i,t,e,r)=>{for(var s=void 0,o=i.length-1,n;o>=0;o--)(n=i[o])&&(s=n(t,e,s)||s);return s&&Ri(t,e,s),s};const ye=class ye extends S{constructor(){super(...arguments),this.heading="",this.subheading="",this.paragraph="",this.imgSrc="",this.imgAlt=""}render(){return w`
      <section class="block">
        ...
        <article class="grid">
          <figure class="column-12">
            <div class="img-mid bg-ic img border">
              ${this.imgSrc?w`<img src=${this.imgSrc} alt=${this.imgAlt} />`:null}
            </div>
          </figure>
        </article>
      </section>
  ...
  `;let jt=ve;Ui([k({attribute:"project-slug"})],jt.prototype,"slug");const Mi=[{path:"/app/project/:slug",view:i=>w`
        <project-view project-slug=${i.slug}></project-view>
      `},{path:"/app/about",view:()=>w`
        <about-view></about-view>
      `},{path:"/app/contact",view:()=>w`
        <contact-view></contact-view>
      `},{path:"/app",view:()=>w`
        <home-view></home-view>
      `},{path:"/",redirect:"/app"}];ei({"mu-auth":er.Provider,"mu-history":ar.Provider,"portfolio-header":Mt,"home-view":gt,"contact-view":yt,"project-view":jt,"mu-switch":class extends Zr.Element{constructor(){super(Mi,"app:history","app:auth")}}});
